...
from .models import db, User, Board, List, Card, Comment, Label
...
app.register_blueprint(board_routes, url_prefix='/api')
app.register_blueprint(list_routes, url_prefix='/api' )
