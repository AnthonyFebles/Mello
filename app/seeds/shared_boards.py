...
#         db.session.execute(
#             f"INSERT INTO {SCHEMA}.shared_boards(user_id, board_id) VALUES (1,1)")
#         db.session.execute(
#             f"INSERT INTO {SCHEMA}.shared_boards(user_id, board_id) VALUES (1,2)")
#         db.session.execute(
#             f"INSERT INTO {SCHEMA}.shared_boards(user_id, board_id) VALUES (2,1)")
#         db.session.execute(
#             f"INSERT INTO {SCHEMA}.shared_boards(user_id, board_id) VALUES (2,2)")
#         db.session.execute(
#             f"INSERT INTO {SCHEMA}.shared_boards(user_id, board_id) VALUES (3,1)")
#         db.session.execute(
#             f"INSERT INTO {SCHEMA}.shared_boards(user_id, board_id) VALUES (3,2)")
#         db.session.execute(
#             f"INSERT INTO {SCHEMA}.shared_boards(user_id, board_id) VALUES (3,3)")
